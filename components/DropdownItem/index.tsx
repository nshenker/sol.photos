    ...
    >
      ...
      <div className={styles.head}>
        <div className={styles.item}>
          ...
          >
            <Image src={value.image} width={48} height={48} alt={value.title} />
          </div>
      ...
      <div className={styles.body}>
        {options.map((x: any, index: number) => (
          ...
          >
            ...
            >
              <Image src={x.image} width={48} height={48} alt={x.title} />
            </div>
            <div className={styles.details}>
              <div className={styles.title}>{x.title}</div>
              <div className={styles.type}>{x.type}</div>
            </div>
            <Icon className={cn(styles.icon, styles.select)} name="check" />
          </div>
        ))}
      </div>
    </div>
